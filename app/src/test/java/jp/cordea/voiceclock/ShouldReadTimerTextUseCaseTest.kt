...
class ShouldReadTimerTextUseCaseTest {
    ...
    fun execute() {
        ...
        assertThat(useCase.execute(Duration.ofSeconds(1), 0)).isFalse()

        assertThat(useCase.execute(Duration.ofSeconds(40), 40)).isTrue()
        assertThat(useCase.execute(Duration.ofSeconds(100), 40)).isFalse()
        assertThat(useCase.execute(Duration.ofSeconds(80), 40)).isTrue()
        assertThat(useCase.execute(Duration.ofSeconds(360), 40)).isTrue()
        ...
        assertThat(useCase.execute(Duration.ofMinutes(2), 60)).isTrue()
        assertThat(useCase.execute(Duration.ofMinutes(50), 60)).isTrue()
        ...
        assertThat(useCase.execute(Duration.ofMinutes(50), 120)).isTrue()
        ...
        assertThat(useCase.execute(Duration.ofHours(2), 3600)).isTrue()
        assertThat(useCase.execute(Duration.ofHours(3), 3600)).isTrue()
        assertThat(useCase.execute(Duration.ofHours(50), 3600)).isTrue()
    }
}
